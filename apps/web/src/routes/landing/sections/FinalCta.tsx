  ...
  return (
    <section className="bg-teal-800 py-16 text-white sm:py-20">
      <Container className="text-center">
        ...
        <Link
          to="/login"
          className="mt-8 inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 text-base font-medium text-teal-800 shadow-soft transition-colors hover:bg-teal-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        >
