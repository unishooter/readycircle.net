      ...
      <Container className="grid items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <Link
              to="/login"
              className="inline-flex items-center justify-center rounded-lg bg-teal-700 px-6 py-3 text-base font-medium text-white shadow-soft transition-colors hover:bg-teal-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-700"
            >
        ...
        <div className="flex justify-center text-teal-500" aria-hidden={false}>
          <CircleIllustration />
        </div>
      </Container>
    </section>
